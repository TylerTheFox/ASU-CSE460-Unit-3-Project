          ...
          switch(choice)
          {
			  ...
			  lastN = scan.nextLine();
                                  ...
                                  boolean found = false;
			  		 			  ...
			  		 			  {
			  		 				if( per.get(i).getFirstName().equals(firstN) && per.get(i).getLastName().equals(lastN))
			  		 				{
			  		 				found = true;
			  		 			    loc = i;
			  		 			    }
			  ...
			  for(int i=0; i<per.getSize(); i++)
			  {
					...
					{
						case 0:
											  per.get(i).printNameFML();
						break:
						case 1:
											  per.get(i).printNameLMF();
						break;
						case 2:
											  per.get(i).printNameLFM();
						break;
					}
			  }
